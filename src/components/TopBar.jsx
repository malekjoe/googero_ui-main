...
const TopBar = ({ open, handleDrawerOpen, setMode, handleDrawerClose }) => {
  ...
  return (
    <AppBar position="fixed" open={open}>
      ...
      <Toolbar>
        <IconButton
          color="inherit"
          aria-label={open ? "close drawer" : "open drawer"} // Update label for accessibility
          onClick={open ? handleDrawerClose : handleDrawerOpen} // Toggle between open/close functions
          edge="start"
          sx={{
            marginRight: 5,
          }}
        >
          <Icon path={open ? mdiMenuOpen : mdiMenuClose} size={1} />{" "}
        ...
        <Stack direction={"row"} className="BarButtons">
